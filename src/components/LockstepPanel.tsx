...
export function LockstepPanel() {
  ...
  return (
    <details className="rounded border-[1.5px] border-ink bg-stock p-3">
      ...
      <div className="mt-3 grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <ul className="mt-1 text-sm text-ink" data-testid="lockstep-browser">
            {browserTools === null ? (
              <li className="text-ink-soft">No WebMCP in this browser.</li>
            ) : (
        ...
        <div>
          <h3 className="text-sm font-bold text-ink">Palette&rsquo;s view · same call</h3>
          <ul className="mt-1 text-sm text-ink" data-testid="lockstep-local">
