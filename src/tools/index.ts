...
import { getBookingState } from "./getBookingState";
...
/**
 * Every tool the site defines. The registry decides which are live; this list
 * never changes at runtime. Tier 1 (PROJECT_SPEC.md §5).
 */
